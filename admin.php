...
<body>
    ...
    <header>
        <div class="container">
            <h1 style="text-align: center;">Hostel Booking Details</h1>
...
$table = "form"; // Change this to your table name

// Columns to select
$columns = array("Sname", "Pname", "Pphone", "Email", "Address", "Indate", "Duration", "Room");
